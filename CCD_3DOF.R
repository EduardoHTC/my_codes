...
#PARA PADRONIZAR O CODIGO, DEFINE-SE AS VARIAVEIS 'var1','var2' e 'var3' COMO OS GRAUS DE LIBERDADE 
#DO PROBLEMA
...
Range_var1 = (lim_sup_var1-CP_var1)/(0.5*sqrt(3))
Range_var2 = (lim_sup_var2-CP_var2)/(0.5*sqrt(3))
Range_var3 = (lim_sup_var3-CP_var3)/(0.5*sqrt(3))
...
Modelo_CCD = ccd(3, n0 = 1, alpha = 'spherical', oneblock = TRUE)
View(Modelo_CCD)
...
write.csv(Modelo_CCD, 'ccd_pontos_3dof.csv')